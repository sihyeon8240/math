...
\begin{definition} \label{an:def:function}
  A relation $f$ from $X$ to $Y$ is called a \textbf{function} if
  \[
...
\begin{definition} \label{an:def:inverse-function}
  ...
  \[
    \forall (y, x) \in Y \times X, (y, x) \in f^{-1} \iff f(x) = y
  \]
