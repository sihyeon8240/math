\begin{definition} \label{an1:def:function}
...
\begin{definition} \label{an1:def:image-inverse-image}
  Suppose $f: X \to Y$.
  \begin{itemize}
...
\begin{definition} \label{an1:def:injective-surjective-bijective}
  Suppose $f: X \to Y$.
  \begin{itemize}
...
\begin{definition} \label{an1:def:inverse-function}
  ...
  \]
  By \cref{an1:def:injective-surjective-bijective},
  \[
    \begin{array}{c}
      \forall y \in Y, \exists! x \in X, f(x) = y \\
      \Downarrow                                  \\
...
\begin{theorem} \label{an1:thm:inverse-function-is-bijective}
  \[
...
\begin{definition} \label{an1:def:restriction-function}
  Suppose $f: X \to Y$. Then
  \begin{itemize}
    \item Suppose $E \subseteq X$. The \textbf{restriction} $f|_{E}: E \to Y$ of $f$ to $E$ is defined by
          \[
            \forall x \in E, f|_{E}(x) = f(x)
          \]
    \item Suppose $f(X) \subseteq F \subseteq Y$. The \textbf{corestriction} $f|^{F}: X \to F$ of $f$ to $F$ is defined by
          \[
    ...
    \item Suppose
          ...
          \end{itemize}
          The \textbf{bi-restriction} $f|_{E}^{F}: E \to F$ of $f$ to $E$ and $F$ is defined by
          \[
...
\begin{theorem} \label{an1:thm:properties-of-restriction-functions}
  Suppose
  \begin{itemize}
    \item $f: X \to Y$
    \item $E \subseteq X$
...
\begin{definition} \label{an1:def:composition-function}
  Suppose
  \begin{itemize}
    \item $f: X \to Y$
    \item $g: Y \to Z$
...
\begin{theorem} \label{an1:thm:properties-of-composition-functions}
  Suppose
  \begin{itemize}
    \item $f: X \to Y$
    \item $g: Y \to Z$
