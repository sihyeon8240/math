...
\begin{proof}
  ...
  Otherwise the standard lcm is a positive common multiple. It divides every positive common multiple $c$, so it is at most $c$. The previously proved uniqueness of the least positive common multiple identifies it with our construction. The conversion of positive $c$ to a natural number leaves its value unchanged.
